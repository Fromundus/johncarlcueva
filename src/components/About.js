...
import { BiLogoTypescript } from "react-icons/bi";
import { SiMysql, SiNextdotjs } from "react-icons/si";
import { SiHostinger } from "react-icons/si";    // generic icon for Hostinger
  ...
  return (
    <section id="about" className="small-section lg:section">
      <div className="flex flex-col items-center justify-center pt-24 pb-0 lg:py-24">
        ...
        <motion.p
          className="mt-10 tracking-widest leading-loose text-center max-w-3xl px-4"
          initial={{ x: -100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
        ...
        >
          <span className="text-3xl font-bold">My Skills</span>
          <div className="flex mt-10 flex-wrap gap-8 items-center justify-center text-center">

            {/* Skill Item */}
            {[
              { icon: <FaHtml5 className="text-orange-500 text-4xl" />, label: "HTML5" },
              { icon: <FaCss3Alt className="text-blue-500 text-4xl" />, label: "CSS3" },
              { icon: <IoLogoJavascript className="text-yellow-400 text-4xl" />, label: "JavaScript" },
              { icon: <BiLogoTypescript className="text-sky-600 text-4xl" />, label: "TypeScript" },
              { icon: <FaReact className="text-sky-400 text-4xl" />, label: "React" },
              { icon: <SiNextdotjs className="text-black text-4xl" />, label: "Next.js" },
              { icon: <FaPhp className="text-indigo-500 text-4xl" />, label: "PHP" },
              { icon: <FaLaravel className="text-red-600 text-4xl" />, label: "Laravel" },
              { icon: <FaBootstrap className="text-purple-500 text-4xl" />, label: "Bootstrap" },
              { icon: <RiTailwindCssFill className="text-cyan-400 text-4xl" />, label: "Tailwind CSS" },
              { icon: <SiMysql className="text-blue-400 text-4xl" />, label: "MySQL" },
              { icon: <FaGitAlt className="text-orange-600 text-4xl" />, label: "Git" },
              { icon: <FaGithub className="text-black text-4xl" />, label: "GitHub" },
              { icon: <SiHostinger className="text-purple-500 text-4xl" />, label: "Hostinger" },
                { icon: <SiVercel className="text-black text-4xl" />, label: "Vercel" }
            ].map((skill, idx) => (
              <div
                key={idx}
                className="flex flex-col items-center p-4 border border-neutral-800 rounded bg-neutral-600 w-24"
              >
                {skill.icon}
