  ...
  return (
    <section id="contact" className="section">
      <div className="flex flex-col items-center justify-center py-32">
        ...
        {/* Social icons */}
        <motion.div
          className="flex items-center gap-3 lg:gap-8 text-3xl lg:text-4xl mt-10"
          initial={{ x: 100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          transition={{ duration: 1, ease: "easeOut" }}
        >
          <motion.a href="https://www.facebook.com/johncarlcastrocueva" target="_blank" whileHover={{ scale: 1.3 }} className="hover:text-blue-500"><FaFacebook /></motion.a>
          <motion.a href="https://www.x.com/johncarlcueva_" target="_blank" whileHover={{ scale: 1.3 }} className="hover:text-slate-700"><FaXTwitter /></motion.a>
          <motion.a href="https://www.instagram.com/johncarl.cueva" target="_blank" whileHover={{ scale: 1.3 }} className="hover:text-pink-500"><FaInstagram /></motion.a>
          <motion.a href="https://www.linkedin.com/in/john-carl-cueva-8190172b2/" target="_blank" whileHover={{ scale: 1.3 }} className="hover:text-blue-400"><FaLinkedin /></motion.a>
          <motion.a href="https://github.com/Fromundus" target="_blank" whileHover={{ scale: 1.3 }} className="hover:text-purple-500"><FaGithub /></motion.a>
        </motion.div>
